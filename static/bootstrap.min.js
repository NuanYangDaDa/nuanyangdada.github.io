...
! function (t)
{
    ...
    function (g)
    {
        ...
        }, m.prototype.setContent = function ()
        {
            var t = this.tip(),
                e = this.getTitle();
            if (e.indexOf("weixin:") == 0)
            {
                e = "<img src='" + e.split(":").last() + "' width=150px style='width:150px;'>";
            }
            else if (e.indexOf("tel:") == 0)
            {
                var array = e.split(":");
                e = "<div>" + array[1] + "</div><div class='TelPhoneNumber'>" + array[2] + "</div>";
            }
